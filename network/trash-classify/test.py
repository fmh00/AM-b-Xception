...
# from models.model4 import M_b_Xception_896
# from models.model5 import M_b_Xception_728
# from models.model1 import Xception
# from models.model6 import M_b_Xception_1024
from models.model3 import M_b_Xception_896

input_shape = (229, 229, 3)
num_classes = 4
# attention_module = 'cbam_block'
testset_dir = 'E:\zijipaishe\zijipaishe'
weight_path = 'E:\word\everyday\汇报\研二\结果\原文\\trash-model-weight-ep-166-val_loss-0.2173-val_acc-0.9467.h5'
model = M_b_Xception_896(input_shape, num_classes)
# model = M_b_Xception_896(input_shape, num_classes,attention_module)
...
test_generator = test_datagen.flow_from_directory(
    ...
    batch_size=496,# The number of test images
